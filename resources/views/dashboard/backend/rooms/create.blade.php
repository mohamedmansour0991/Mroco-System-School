    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('models.add_room') }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.rooms.index') }}">{{ __('models.rooms') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('models.add_room') }}</li>
                        </ol>
                    </div>
        ...
        <div class="card-body">
            <div class="live-preview">
                ...
                <form class="row g-3 needs-validation" method="POST" action="{{ route('admin.rooms.store') }}" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="body" value="{{ old('body') }}" id="body"  required>
                         <div class="valid-feedback">
                            Looks good!
                        </div>
                        @error('body')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="floor" value="{{ old('floor') }}" id="floor"  required>
                         <div class="valid-feedback">
                            Looks good!
                        </div>
                        @error('floor')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" name="hall_no" value="{{ old('hall_no') }}" id="hall_no"  required>
                         <div class="valid-feedback">
                            Looks good!
                        </div>
                        @error('hall_no')

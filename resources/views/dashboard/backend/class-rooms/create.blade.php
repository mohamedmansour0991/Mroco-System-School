    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('models.add_class_room') }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.class-rooms.index') }}">{{ __('models.class_rooms') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('models.add_class_room') }}</li>
                        </ol>
                    </div>
        ...
        <div class="card-body">
            <div class="live-preview">
                ...
                <form class="row g-3 needs-validation" method="POST" action="{{ route('admin.class-rooms.store') }}" enctype="multipart/form-data" novalidate>
